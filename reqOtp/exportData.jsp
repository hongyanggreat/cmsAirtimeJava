...
<%
    ...
    if (!Tool.checkNull(session.getAttribute("otpHistoryExport"))) {
        String pages = "";
...
//        out.println("LAY DU LIEU VA XUAT FILE");
        ArrayList<AirtimeReq> datas = (ArrayList<AirtimeReq>) session.getAttribute("otpHistoryExport");
        out.clear();
...
//        Map<String, Object[]> data = new HashMap<String, Object[]>();
        ...
        try {
            ...
            response.setHeader("Content-Disposition", "attachment; filename=history-otp-" + DateProc.createDDMMYYYY() + "-" + pages + ".xlsx");
