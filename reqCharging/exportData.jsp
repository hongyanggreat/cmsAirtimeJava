...
<%
    ...
    if (!Tool.checkNull(session.getAttribute("chargeHistoryExport"))) {
        String pages = "";
...
//        out.println("LAY DU LIEU VA XUAT FILE");
        ArrayList<AirtimeReq> datas = (ArrayList<AirtimeReq>) session.getAttribute("chargeHistoryExport");
        out.clear();
...
//        Map<String, Object[]> data = new HashMap<String, Object[]>();
        ...
        try {
            ...
            response.setHeader("Content-Disposition", "attachment; filename=history-charging-" + DateProc.createDDMMYYYY() + "-" + pages + ".xlsx");
